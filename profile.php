					...
					<div class='row'>
						<div class='datas'>
							<div class='col-sm-offset-3 col-sm-6'>								
								<div class='col-sm-6'><h4>Teljes Név</h4></div>
								<div class='col-sm-6'><input type='text' id='fullname'></div>
								<div class='col-sm-6'></div><div class='col-sm-6'><span id='fn'></span></div>
							</div>
							
							<div class='col-sm-offset-3 col-sm-6'>								
								<div class='col-sm-6'><h4>Születés</h4></div>
								<div class='col-sm-6'><input type='text' id='birthday'></div>
								<div class='col-sm-6'></div><div class='col-sm-6'><span id='bd'></span></div>
							</div>
							
							<div class='col-sm-offset-3 col-sm-6'>
								<div class='col-sm-6'></div><div class='col-sm-6'><span id='s'></span></div>
								<div class='col-sm-6'><h4>Nem</h4></div>
								<div class='col-sm-6'>
									<select id='sex'>
							...
							<div class='col-sm-offset-3 col-sm-6'>								
								<div class='col-sm-6'><h4>Magasság</h4></div>
								<div class='col-sm-6'><input type='text' id='height'></div>
								<div class='col-sm-6'></div><div class='col-sm-6'><span id='hght'></span></div>
							</div>
							
							<div class='col-sm-offset-3 col-sm-6'>								
								<div class='col-sm-6'><h4>Súly</h4></div>
								<div class='col-sm-6'><input type='text' id='weight'></div>
								<div class='col-sm-6'></div><div class='col-sm-6'><span id='wght'></span></div>
							</div>
